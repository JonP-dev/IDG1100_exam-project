...
curl -s https://en.wikipedia.org/wiki/List_of_municipalities_of_Norway > page-text.html.txt

### Removing whitespace characters (also tabs).
cat "page-text.html.txt" | tr -d '\n\t' > "page-text_one_line.html.txt"
